        ...
        for sub_data_name in os.listdir(sub_dir_path):
            ...
            if mode == 'FFT':
                ...
                try:
                    ...
                    print(f"Error in computing melspectrogram: {e}")
                    spect = None
                ...
                if spect is not None:
                    try:
                        ...
                        print(f"Error in converting power to dB: {e}")
                        mel_spect = None

                    if mel_spect is not None:
                        try:
                            librosa.display.specshow(mel_spect, sr=2000, x_axis='time', y_axis='mel')
                        except Exception as e:
                            print(f"Error in displaying the spectrogram: {e}")
...
if __name__ == '__main__':
    ...
    spec_mode = 'Mel'  # Todo:预处理模式 ['FFT', 'STFT', 'CWT', 'Mel']
    ...
    # crop_window(data_path, time, crop_output_path, window_rate)  # Todo: if First, Run it.
